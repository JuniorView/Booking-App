...
public:
    ...
    QAction *actionAnzeigen;
    QAction *actionset_config;
    ...
    void setupUi(QMainWindow *Travelagencyui)
    {
        ...
        actionAnzeigen = new QAction(Travelagencyui);
        actionAnzeigen->setObjectName(QString::fromUtf8("actionAnzeigen"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/new/iconss/meldung.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        actionAnzeigen->setIcon(icon2);
        actionset_config = new QAction(Travelagencyui);
        actionset_config->setObjectName(QString::fromUtf8("actionset_config"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/new/iconss/configuration.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        actionset_config->setIcon(icon3);
        ...
        layoutWidget = new QWidget(flug);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(11, 18, 351, 311));
        ...
        fromDateFlug = new QLineEdit(layoutWidget);
        ...
        toDateflug = new QLineEdit(layoutWidget);
        ...
        bookingclassFlug = new QLineEdit(layoutWidget);
        ...
        departurAirportNameEdit = new QLineEdit(layoutWidget);
        ...
        arrivalAirportNameEdit = new QLineEdit(layoutWidget);
        ...
        layoutWidget1 = new QWidget(mietwagen);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(20, 40, 341, 241));
        ...
        pickuplocationEdit = new QLineEdit(layoutWidget1);
        ...
        returnlocationedit = new QLineEdit(layoutWidget1);
        ...
        vehicleclassedit = new QLineEdit(layoutWidget1);
        ...
        layoutWidget2 = new QWidget(hotel);
        layoutWidget2->setObjectName(QString::fromUtf8("layoutWidget2"));
        layoutWidget2->setGeometry(QRect(13, 40, 361, 151));
        ...
        hotelEdit = new QLineEdit(layoutWidget2);
        ...
        townEdit = new QLineEdit(layoutWidget2);
        ...
        roomtypeedit = new QLineEdit(layoutWidget2);
        ...
        layoutWidget3 = new QWidget(zug);
        layoutWidget3->setObjectName(QString::fromUtf8("layoutWidget3"));
        layoutWidget3->setGeometry(QRect(30, 20, 341, 152));
        ...
        fromDestEdit = new QLineEdit(layoutWidget3);
        ...
        departureTimeEdit = new QTimeEdit(layoutWidget3);
        ...
        toDestEdit = new QLineEdit(layoutWidget3);
        ...
        arrivalTimeEdit = new QTimeEdit(layoutWidget3);
        ...
        ticketTypEdit = new QLineEdit(layoutWidget3);
        ...
        menuMeldungen = new QMenu(menubar);
        menuMeldungen->setObjectName(QString::fromUtf8("menuMeldungen"));
        ...
        menubar->addAction(menuMeldungen->menuAction());
        ...
        menuMeldungen->addAction(actionAnzeigen);
        menuConfiguration->addAction(actionset_config);
        toolBar->addAction(actionEinlesen);
        toolBar->addAction(actionsuchen);
        toolBar->addAction(actionAnzeigen);
        toolBar->addAction(actionset_config);
    ...
    void retranslateUi(QMainWindow *Travelagencyui)
    {
        ...
        actionAnzeigen->setText(QApplication::translate("Travelagencyui", "Anzeigen", nullptr));
        actionset_config->setText(QApplication::translate("Travelagencyui", "set_config", nullptr));
        ...
        menuMeldungen->setTitle(QApplication::translate("Travelagencyui", "Meldungen", nullptr));
        menuConfiguration->setTitle(QApplication::translate("Travelagencyui", "Configuration", nullptr));
